...
class ClustersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cluster" do
    assert_difference('Cluster.count') do
      post clusters_url, params: { cluster: { apartment_address: @cluster.apartment_address, apartment_name: @cluster.apartment_name } }
    end
  ...
  test "should update cluster" do
    patch cluster_url(@cluster), params: { cluster: { apartment_address: @cluster.apartment_address, apartment_name: @cluster.apartment_name } }
