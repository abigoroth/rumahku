class ParkSpacesController < ApplicationController
  ...
  private
    ...
    def park_space_params
      params.require(:park_space).permit(:parknum, :spacetype, :available, :info_id, :user_id, { apartments_attributes: [:id, :requested_park_space_id, :requested_start_rent, :requested_end_rent, :_destroy]}, {cars_attributes: [:id, :cartype, :owner, :platnum, :_destroy]})
    end
